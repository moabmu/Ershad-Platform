...
namespace ModepEduYanbu.Data.Migrations
{
    ...
    [Migration("20200228070627_Prevent_Identical_EduProgramNames_Index")]
    partial class Prevent_Identical_EduProgramNames_Index
    {
            ...
            modelBuilder.Entity("ModepEduYanbu.Models.EduProgram", b =>
                {
                    ...
                    b.Property<bool>("QuartzJob_ComputeReportKpisJobStartsRunning");
                    ...
                    b.HasIndex("Name", "EducationalYearId")
                        .IsUnique()
                        .HasName("Prevent_Identical_EduProgramNames")
                        .HasFilter("[Name] IS NOT NULL AND [EducationalYearId] IS NOT NULL");
